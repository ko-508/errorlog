...
**Azure [CLI](/glossary/cli/) の複数[アカウント](/glossary/アカウント/)管理：** 複数の Azure サブスクリプションやテナントにアクセスしている場合、`az account show` でアクティブな[アカウント](/glossary/アカウント/)を確認し、`az account set --subscription <subscription-id>` で対象サブスクリプションに切り替えてください。誤った[アカウント](/glossary/アカウント/)で[認証](/glossary/認証/)されている場合も 401 [エラー](/glossary/エラー/)が発生します。
