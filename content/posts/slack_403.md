...
Slack [API](/glossary/api/) を使用してメッセージを送信したり、チャンネルを操作しようとした際に 403 エラーが返される場合があります。このエラーは[認証](/glossary/認証/)（ログイン）には成功しているものの、実行しようとした操作やアクセス対象のチャンネルに対する[権限](/glossary/権限/)がないことを示しています。
