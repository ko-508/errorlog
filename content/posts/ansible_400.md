...
`offline`[パラメータ](/glossary/パラメータ/)が古い[バージョン](/glossary/バージョン/)のモジュール仕様であり、新しいAnsibleでは削除された可能性があります。最新のモジュール仕様に合わせて[パラメータ](/glossary/パラメータ/)を[修正](/glossary/修正/)しました。
