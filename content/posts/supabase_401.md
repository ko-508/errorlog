...
**JavaScript/TypeScript [クライアント](/glossary/クライアント/)での出力：**
...
Supabase [プロジェクト](/glossary/プロジェクト/)には複数の[認証](/glossary/認証/)[キー](/glossary/キー/)が存在します。anonymous [キー](/glossary/キー/)（anon key）は[クライアント](/glossary/クライアント/)側で使用するもので、service role [キー](/glossary/キー/)は[バックエンド](/glossary/バックエンド/)限定です。[キー](/glossary/キー/)の値が誤っていたり、異なる[プロジェクト](/glossary/プロジェクト/)の[キー](/glossary/キー/)を混在させると 401 [エラー](/glossary/エラー/)が発生します。
...
Supabase の [JWT](/glossary/jwt/) [トークン](/glossary/トークン/)には[デフォルト](/glossary/デフォルト/)で 1 時間の有効期限があります。ユーザーが[ログイン](/glossary/ログイン/)後、時間が経過して[セッション](/glossary/セッション/)が切れた状態で[リクエスト](/glossary/リクエスト/)を[送信](/glossary/送信/)すると 401 [エラー](/glossary/エラー/)が返されます。特にモバイルアプリや[バックグラウンド](/glossary/バックグラウンド/)で長時間実行される[アプリケーション](/glossary/アプリケーション/)で頻出します。
