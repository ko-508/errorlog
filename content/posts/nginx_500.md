...
PHP、Python、Node.js などのアプリケーション内部で例外やクラッシュが発生している場合、[バックエンド](/glossary/バックエンド/)が 500 [レスポンス](/glossary/レスポンス/)を返します。
...
これらの[ヘッダー](/glossary/ヘッダー/)がないと、アプリケーション側で不正な[リクエスト](/glossary/リクエスト/)と判定し 500 [エラー](/glossary/エラー/)を返すことがあります。
