...
[バックエンド](/glossary/バックエンド/)の一部がダウンしている場合、他の[サーバー](/glossary/サーバー/)に[リクエスト](/glossary/リクエスト/)を[リトライ](/glossary/リトライ/)させることで 500 エラーを回避できます。
...
バックエンドアプリケーションが クライアント IP や [プロトコル](/glossary/プロトコル/)を正しく取得できないと、セッション検証やセキュリティチェックで失敗して 500 エラーが発生することがあります。
