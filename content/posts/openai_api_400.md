...
**新しい[モデル](/glossary/モデル/)の確認**：OpenAI [API](/glossary/api/)は頻繁に新しい[モデル](/glossary/モデル/)が追加され、古い[モデル](/glossary/モデル/)はサポートが終了します。`gpt-3.5-turbo`や`gpt-4-turbo-preview`など、常に最新の有効な[モデル](/glossary/モデル/)[ID](/glossary/id/)を使用してください。
