...
カスタム関数を呼び出す際に、[エンドポイント](/glossary/エンドポイント/) [URL](/glossary/url/) が完全でない、または関数名を誤って指定した場合に 404 が発生します。特にローカル開発環境とプロダクション環境で[エンドポイント](/glossary/エンドポイント/)が異なることに気づかずミスが起きます。
...
プロジェクトの Functions セクションにアクセスし、対象の関数をクリックすると、[デプロイ](/glossary/デプロイ/)済み[エンドポイント](/glossary/エンドポイント/)の正確な [URL](/glossary/url/) が表示されます。
...
4. 「Functions」セクションで関数が[デプロイ](/glossary/デプロイ/)済みか、[エンドポイント](/glossary/エンドポイント/) [URL](/glossary/url/) が表示されているか確認
