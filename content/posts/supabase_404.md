...
Supabase の 404 [エラー](/glossary/エラー/)は、[クライアント](/glossary/クライアント/)側からの[リクエスト](/glossary/リクエスト/)が指定した[テーブル](/glossary/テーブル/)・行・ストレージオブジェクト・Functions [エンドポイント](/glossary/エンドポイント/)が見つからないことを示します。[データベース](/glossary/データベース/)操作、ファイルアップロード、カスタム関数呼び出しなどの様々な場面で発生し、多くの場合はリソース名の指定ミスが原因です。
...
**[ストレージ](/glossary/ストレージ/)操作での 404 [エラー](/glossary/エラー/)：**
...
Storage [オブジェクト](/glossary/オブジェクト/)を[ダウンロード](/glossary/ダウンロード/)・[削除](/glossary/削除/)する際に、[バケット](/glossary/バケット/)名やファイルパスの指定が間違っていると 404 が返されます。[パス](/glossary/パス/)の先頭スラッシュの有無や、ネストされたフォルダー構造の指定ミスもよくある原因です。
...
Dashboard の Storage セクションで[バケット](/glossary/バケット/)一覧を開き、各[バケット](/glossary/バケット/)内の[ファイル](/glossary/ファイル/)構造を確認すると、正確な[パス](/glossary/パス/)を特定できます。
...
[プロジェクト](/glossary/プロジェクト/)の Functions セクションにアクセスし、対象の[関数](/glossary/関数/)をクリックすると、[デプロイ](/glossary/デプロイ/)済み[エンドポイント](/glossary/エンドポイント/)の正確な [URL](/glossary/url/) が表示されます。
...
1. ページ上部の[プロジェクト](/glossary/プロジェクト/)名をクリックし、[ダッシュボード](/glossary/ダッシュボード/)のホームに戻る
...
4. 「Functions」セクションで[関数](/glossary/関数/)が[デプロイ](/glossary/デプロイ/)済みか、[エンドポイント](/glossary/エンドポイント/) [URL](/glossary/url/) が表示されているか確認

**[ブラウザ](/glossary/ブラウザ/)の開発者[ツール](/glossary/ツール/)での[ネットワーク](/glossary/ネットワーク/)確認：**
...
**Supabase JavaScript [クライアント](/glossary/クライアント/)の[デバッグ](/glossary/デバッグ/)出力：**
