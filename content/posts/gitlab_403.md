...
**Admin → Users** から対象ユーザーを検索し、最後に[権限](/glossary/権限/)が変更された時刻を確認します。権限変更直後であれば、[セッション](/glossary/セッション/)を[リセット](/glossary/リセット/)するため一度[ログアウト](/glossary/ログアウト/)・[ログイン](/glossary/ログイン/)を試みます。
