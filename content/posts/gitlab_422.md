...
マージリクエストテンプレートが設定されている[プロジェクト](/glossary/プロジェクト/)では、テンプレートの必須フィールドを満たさないと422[エラー](/glossary/エラー/)が発生することもあります。この場合、[プロジェクト](/glossary/プロジェクト/)設定の「マージリクエスト」セクションでテンプレート内容を確認してください。
