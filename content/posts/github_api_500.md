...
※ 不正な [JSON](/glossary/json/) や形式[エラー](/glossary/エラー/)は通常 400 Bad Request や 422 を返します。500 Internal Server Error は本来 GitHub 側の問題で、まず GitHub Status の確認と[リトライ](/glossary/リトライ/)を優先してください。クライアント側の[リクエスト](/glossary/リクエスト/)形式が 500 を誘発するのは例外的なケースです。
