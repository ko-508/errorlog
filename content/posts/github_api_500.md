...
> この記事では、**GitHub [API](/glossary/api/)** を使っているときに表示される **500** というエラーの意味と、その直し方を順を追って説明します。
...
GitHub [API](/glossary/api/) で 500 が出るときに、最もよく見られる原因を挙げます。
...
GitHub [API](/glossary/api/) の **500** エラーは、上記のいずれかの原因によって発生するケースがほとんどです。
