...
もう1つの落とし穴が共有メモリゾーンの枯渇です。ゾーンの空きがなくなると最も古い状態から削除されますが、それでも新しい状態を作れない場合、その[リクエスト](/glossary/リクエスト/)は拒否されます。公式ドキュメントによると、状態1件は64[ビット](/glossary/ビット/)[環境](/glossary/環境/)で128[バイト](/glossary/バイト/)を占め、1MB のゾーンに約8千件です。[クライアント](/glossary/クライアント/)数に対してゾーンが小さすぎないか確認してください。
