...
**JavaScript [クライアント](/glossary/クライアント/)出力例：**
...
複数の[クライアント](/glossary/クライアント/)が同時に同じ[レコード](/glossary/レコード/)を更新した場合、またはバッチ処理中に同じユニークキーを持つ[レコード](/glossary/レコード/)が複数回 INSERT される場合に競合します。特にリアルタイムアプリケーションやインポート処理で発生しやすくなります。
...
この[コマンド](/glossary/コマンド/)で `supabase/migrations/` [ディレクトリ](/glossary/ディレクトリ/)に [SQL](/glossary/sql/) [スキーマ](/glossary/スキーマ/)が出力され、実際の制約定義を目視確認できます。
