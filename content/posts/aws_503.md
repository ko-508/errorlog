...
バックエンドが応答しないため、Application Load Balancer（ALB）や Network Load Balancer（NLB）が[リクエスト](/glossary/リクエスト/)を処理できなくなります。[ヘルスチェック](/glossary/ヘルスチェック/)が失敗すると、すべてのターゲットが unhealthy と判定されます。
...
ターゲットグループの[ヘルスチェック](/glossary/ヘルスチェック/)設定を確認し、タイムアウトや[ポート](/glossary/ポート/)設定が正しいか検証してください。
