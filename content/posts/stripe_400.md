...
> Stripe [API](/glossary/api/)への[リクエスト](/glossary/リクエスト/)の形式または内容に誤りがある。
...
- 必須[パラメータ](/glossary/パラメータ/)が欠けているか型が間違っている
- 通貨コードや金額の値が不正（例：小数点以下を含む金額など）
- [パラメータ](/glossary/パラメータ/)の組み合わせが許可されていない
...
1. Stripe[ダッシュボード](/glossary/ダッシュボード/)のログで[リクエスト](/glossary/リクエスト/)/[レスポンス](/glossary/レスポンス/)の詳細を確認する
1. [エラーレスポンス](/glossary/エラーレスポンス/)のparam欄で問題の[パラメータ](/glossary/パラメータ/)を特定する
1. Stripe [API](/glossary/api/)リファレンスで各[パラメータ](/glossary/パラメータ/)の型と必須条件を確認する
