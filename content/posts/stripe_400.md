...
[ネットワーク](/glossary/ネットワーク/)障害により同じ[リクエスト](/glossary/リクエスト/)が複数回送信されるのを防ぐため、`Idempotency-Key`[ヘッダー](/glossary/ヘッダー/)を使用します。同じキーで[送信](/glossary/送信/)された[リクエスト](/glossary/リクエスト/)は自動的に重複排除され、重複作成を防げます。このキーを省略すると、予期しない重複決済が発生する可能性があります。
