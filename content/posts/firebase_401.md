...
> Firebaseへのアクセスに有効な[認証](/glossary/認証/)情報が提供されていない。
...
- FirebaseのID[トークン](/glossary/トークン/)の有効期限が切れている（通常1時間）
- [サービスアカウント](/glossary/サービスアカウント/)の鍵ファイルが古いか間違っている
...
1. クライアント[SDK](/glossary/sdk/)でauth.currentUser.getIdToken(true)を呼び出して[トークン](/glossary/トークン/)を強制更新する
1. Firebase[コンソール](/glossary/コンソール/)で[サービスアカウント](/glossary/サービスアカウント/)の鍵を再生成してダウンロードする
1. [環境変数](/glossary/環境変数/)のパスが鍵ファイルの実際の場所と一致しているか確認する
