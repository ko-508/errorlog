...
[本番環境](/glossary/本番環境/)では使用禁止ですが、開発中の一時的な[デバッグ](/glossary/デバッグ/)には以下のルールが有効です。
...
Firebase コミュニティ StackOverflow の `firebase` [タグ](/glossary/タグ/)、または [firebase-tools GitHub Issues](https://github.com/firebase/firebase-tools/issues) で同様の事例を[検索](/glossary/検索/)し、解決策を参照することをお勧めします。
