...
[ワークスペース](/glossary/ワークスペース/)の管理者がアプリをアンインストールした場合、その[トークン](/glossary/トークン/)はもはや有効ではありません。再度[認証](/glossary/認証/)が必要になります。
...
- **Slack サ[ポート](/glossary/ポート/)に問い合わせ**：[ワークスペース](/glossary/ワークスペース/)の管理者権限で対応が必要な場合もあります
