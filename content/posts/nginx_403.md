...
[ファイル](/glossary/ファイル/)自体が 644 で正しくても、ルート(`/`)から対象[ファイル](/glossary/ファイル/)までの[パス](/glossary/パス/)上のどこかの[ディレクトリ](/glossary/ディレクトリ/)に、ワーカーユーザーの実行(検索)[権限](/glossary/権限/)がないと、Nginx はそこを通り抜けられず 403 になります。見落としやすい典型例です。
