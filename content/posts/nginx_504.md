...
なお、似た状況で別の[コード](/glossary/コード/)になる場合があります。上流への接続が即座に拒否された場合（プロセス停止・[ポート](/glossary/ポート/)違い）は504ではなく502です。また、Nginx が待っている間に[クライアント](/glossary/クライアント/)側が先に諦めて切断した場合は、誰にも何も返らず、アクセスログに499が記録されます。
