...
Supabaseはリージョンごとに独立した制限を持つため、複数の[プロジェクト](/glossary/プロジェクト/)を運用している場合は各[プロジェクト](/glossary/プロジェクト/)の使用状況を個別に確認する必要があります。開発環境と本番環境で異なる[プロジェクト](/glossary/プロジェクト/)を使い分けている場合、本番環境だけが429[エラー](/glossary/エラー/)になるケースも一般的です。
