...
リソースを[削除](/glossary/削除/)してから数秒以内に同じ名前で新しいリソースを作成しようとすると、削除処理が[バックエンド](/glossary/バックエンド/)で完全に終了していないため 409 [エラー](/glossary/エラー/)が発生します。特にストレージアカウントや App Service Plan では数秒から数分の遅延が生じることがあります。
