...
Vercel でプロジェクトを更新・再[デプロイ](/glossary/デプロイ/)したり、本番環境の[ドメイン](/glossary/ドメイン/)を変更したりすると、以前のデプロイメント URL は自動的に無効化されます。ブラウザのブックマークやスクリプトに古い URL が残っていると、404 [エラー](/glossary/エラー/)が発生します。また、手動で URL を入力する際の誤字も考えられます。
