...
date: 2026-06-16
description: "テスト対象のAPIへのアクセス権限がない。Postman 403 エラーの原因と解決策を解説します。"
tags: ["Postman"]
errorCode: "403"
service: "Postman"
error_type: "403"
...
[テスト](/glossary/テスト/)対象の[API](/glossary/api/)がIPホワイトリスト機能を有効にしている場合、Postman CloudやローカルのPostmanアプリケーションからの[リクエスト](/glossary/リクエスト/)が許可されていないIPアドレスから送信されると403[エラー](/glossary/エラー/)が返されます。特にPostman Cloudを使用している場合、固定IPアドレスではなく複数の送信元IPを持つため、事前にホワイトリストに登録する必要があります。
