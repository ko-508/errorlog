...
GitHubアプリを使うと、ユーザーごとに制限が独立するため、複数ユーザーの[リクエスト](/glossary/リクエスト/)を扱う場合に有利です。一方、[OAuth](/glossary/oauth/)アプリは[アプリケーション](/glossary/アプリケーション/)全体で制限が共有されます。
...
[アプリケーション](/glossary/アプリケーション/)に以下を追加して詳細[ログ](/glossary/ログ/)を記録します：
