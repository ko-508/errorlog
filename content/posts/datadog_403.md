...
組織の管理者が[セキュリティ](/glossary/セキュリティ/)上の理由でアプリケーションキーを削除した場合、その[キー](/glossary/キー/)を使用するすべての [API](/glossary/api/) 呼び出しが 403 [エラー](/glossary/エラー/)になります。[キー](/glossary/キー/)が Active な状態でなくなると、たとえ[スコープ](/glossary/スコープ/)が正しくても拒否されます。
