...
Datadog エージェントが Datadog [サーバー](/glossary/サーバー/)に[通信](/glossary/通信/)できない[ネットワーク](/glossary/ネットワーク/)[環境](/glossary/環境/)（[ファイアウォール](/glossary/ファイアウォール/)、[プロキシ](/glossary/プロキシ/)経由）では 503 が返される場合があります。特に企業[ネットワーク](/glossary/ネットワーク/)[環境](/glossary/環境/)で代理[サーバー](/glossary/サーバー/)を経由する場合、[プロキシ](/glossary/プロキシ/)認証設定が必要です。
