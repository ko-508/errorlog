...
パイプラインや[ワークフロー](/glossary/ワークフロー/)を直接指定する際に、存在しない[ID](/glossary/id/) を使用すると 404 [エラー](/glossary/エラー/)が発生します。これは [ID](/glossary/id/) の入力ミス、削除済みパイプラインへのアクセス、あるいは別の[プロジェクト](/glossary/プロジェクト/)のパイプライン[ID](/glossary/id/) を誤って使用した場合に起こります。
