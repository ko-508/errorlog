...
これらのどれでもなく、権限の問題を疑っているのに 404 が返っている場合は、classic トークンの scope や非公開リソースへのアクセス権の問題です（[404 の記事](/posts/github_api_404/)）。認証自体の失敗（Bad credentials）は 401 です（[401 の記事](/posts/github_api_401/)）。
