...
GitHub の公式フォーラム（GitHub Discussions）や Stack Overflow の `github-api` [タグ](/glossary/タグ/)で、類似の問題報告が多数あります。[エラーメッセージ](/glossary/エラーメッセージ/)の全文とトークンスコープの情報を共有することで、より正確な回答が得られます。
