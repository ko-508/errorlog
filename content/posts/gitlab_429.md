...
スクリプトや[ツール](/glossary/ツール/)が迅速に連続した[API](/glossary/api/)コールを実行する際、GitLabの[レート制限](/glossary/レート制限/)に即座に到達します。例えば、多数の[プロジェクト](/glossary/プロジェクト/)やグループの[メタデータ](/glossary/メタデータ/)を一括取得する場合、[ループ](/glossary/ループ/)処理で制限を超えやすくなります。
