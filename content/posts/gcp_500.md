...
GCP[アカウント](/glossary/アカウント/)で設定されているCPU、メモリ、ディスク容量などのクォータに達している場合、内部[エラー](/glossary/エラー/)として500が返されることがあります。特にCompute Engineの自動スケーリング時やBigQueryの大規模[クエリ](/glossary/クエリ/)実行時に顕著です。
...
Cloud [SQL](/glossary/sql/)やFirestoreなどのバックエンドサービスの接続プール枯渇、またはメモリ不足によるGC処理中の[エラー](/glossary/エラー/)が500の原因となります。
