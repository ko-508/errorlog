...
> Firestoreの[トランザクション](/glossary/トランザクション/)が他の操作と競合し、完了できなかった。
...
- 複数のクライアントが同じドキュメントに対して同時に書き込み[トランザクション](/glossary/トランザクション/)を実行している
...
1. [トランザクション](/glossary/トランザクション/)の中で[リトライ](/glossary/リトライ/)ロジックを実装する（Firestore[トランザクション](/glossary/トランザクション/)は自動[リトライ](/glossary/リトライ/)するが上限あり）
