...
認証済みのユーザートークンで[リクエスト](/glossary/リクエスト/)を[送信](/glossary/送信/)した場合、RLS [ポリシー](/glossary/ポリシー/)がそのユーザーに該当データへのアクセスを許可しているかが厳密にチェックされます。[ポリシー](/glossary/ポリシー/)で `auth.uid()` を使った条件が正しく設定されていないと、自分以外のデータにアクセスできず 403 [エラー](/glossary/エラー/)が発生します。
