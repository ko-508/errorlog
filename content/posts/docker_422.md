...
[Docker](/glossary/docker/) Hub や Private Registry に[ログイン](/glossary/ログイン/)後、プッシュ時に 422 が出る場合は、[イメージ](/glossary/イメージ/)名が登録済みプロジェクトの[パス](/glossary/パス/)構造に一致しているか確認します。
