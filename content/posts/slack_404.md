...
date: 2026-05-27
description: "Slack APIで404エラーが返される場合、指定したチャンネル・メッセージ・ユーザーなどのリソースがSlackワークスペース内に存在しないか、認証ユーザーにアクセス権限がないことを意味します。"
tags: ["Slack"]
errorCode: "404"
lastmod: 2026-06-14
refresh_due: true
...
チャンネルが[削除](/glossary/削除/)された後、そのチャンネル[ID](/glossary/id/)に対して[API](/glossary/api/)[リクエスト](/glossary/リクエスト/)を実行すると404が返されます。[アーカイブ](/glossary/アーカイブ/)されたチャンネルと[削除](/glossary/削除/)されたチャンネルは異なり、削除後は復旧できません。
