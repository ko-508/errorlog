...
- [認証](/glossary/認証/)メールの送信回数が上限に達した
...
1. Firebase[コンソール](/glossary/コンソール/)の「使用量と請求」でどの枠が上限に達しているか確認する
1. 有料プラン（Blazeプラン）へアップグレードする
1. クライアント側の[キャッシュ](/glossary/キャッシュ/)を活用してFirestoreへの読み取り[リクエスト](/glossary/リクエスト/)数を減らす
