...
したがって画面に出た時点で、それは2回目の失敗です。退避先を[削除](/glossary/削除/)できなかったか、[削除](/glossary/削除/)した直後に誰かが作り直したかのどちらかに絞れます。前者は[ファイル](/glossary/ファイル/)システムの制約、後者は同時に動いている別の[プロセス](/glossary/プロセス/)です。
...
確認方法は[プロセス](/glossary/プロセス/)の照会です。
