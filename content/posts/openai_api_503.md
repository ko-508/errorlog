...
> この記事では、**OpenAI [API](/glossary/api/)** を使っているときに表示される **503** というエラーの意味と、その直し方を順を追って説明します。
...
OpenAI [API](/glossary/api/) で 503 が出るときに、最もよく見られる原因を挙げます。
...
OpenAI [API](/glossary/api/) の **503** エラーは、上記のいずれかの原因によって発生するケースがほとんどです。
