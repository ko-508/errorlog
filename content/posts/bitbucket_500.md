...
ローカル環境からの接続、企業[ファイアウォール](/glossary/ファイアウォール/)経由の接続、または VPN 接続時に、中間[プロキシ](/glossary/プロキシ/)やゲートウェイが Bitbucket との[通信](/glossary/通信/)を正しく処理できず、[サーバー](/glossary/サーバー/)から 500 [エラー](/glossary/エラー/)が返される場合があります。リトライロジックの不備や [TLS](/glossary/tls/) ハンドシェイク（暗号化通信開始時の処理）の失敗も原因となります。
...
- [ネットワーク](/glossary/ネットワーク/)環境（[プロキシ](/glossary/プロキシ/)の有無、VPN 使用状況）
