...
> この記事では、**[Docker](/glossary/docker/)** を使っているときに表示される **404** というエラーの意味と、その直し方を順を追って説明します。
...
> 指定したリソース（イメージや[コンテナ](/glossary/コンテナ/)）が見つからない。
...
1. [Docker](/glossary/docker/) Hubでイメージ名とタグが正しいか検索する
