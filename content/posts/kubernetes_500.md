...
[Kubernetes](/glossary/kubernetes/)[環境](/glossary/環境/)で500[エラー](/glossary/エラー/)が発生した場合、[API](/glossary/api/)[サーバー](/glossary/サーバー/)またはコントロールプレーンコンポーネントで予期しない内部[エラー](/glossary/エラー/)が生じています。この[エラー](/glossary/エラー/)はクラスタ全体の管理機能に影響を与える可能性があり、迅速な対応が必要です。500[エラー](/glossary/エラー/)が返される場合、リソースの作成・更新・[削除](/glossary/削除/)やクラスタ情報の取得が失敗することになります。
