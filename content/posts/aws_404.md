...
AWS [CLI](/glossary/cli/) でのエラーメッセージ：
...
リソース名に小文字・大文字の違いやハイフンの位置が異なると 404 [エラー](/glossary/エラー/)が発生します。AWS では大文字小文字を区別するサービスが多いため、タイプミスは高確率で 404 につながります。
...
S3 バケットポリシーでパブリックアクセスがブロックされている場合、[バケット](/glossary/バケット/)やオブジェクトが存在しても 404 が返されることがあります。これは[セキュリティ](/glossary/セキュリティ/)上の理由から仕様通りの動作です。
