...
Stripe の [GitHub](/glossary/github/) [リポジトリ](/glossary/リポジトリ/)で同じ問題を報告しているユーザーがいないか確認できます。また、Stripe サポートは 24 時間対応なので、[アカウント](/glossary/アカウント/)関連の制限が原因と疑われる場合は直接問い合わせることをお勧めします。
