...
[Webhook](/glossary/webhook/) [エンドポイント](/glossary/エンドポイント/)への 403 エラーは、Stripe ダッシュボードで設定した IP ホワイトリストに Stripe のサーバー IP が含まれていない場合に発生します。本来はリクエストソースの[認証](/glossary/認証/)なので 401 が適切ですが、一部の構成では 403 として返ることがあります。
