...
`uri` モジュールや `get_url` モジュールで外部 [API](/glossary/api/) に接続する際、[エンドポイント](/glossary/エンドポイント/)の URL が誤っているか、[API](/glossary/api/) 側で廃止されている可能性があります。特に [API](/glossary/api/) のバージョンが変更された場合は旧[エンドポイント](/glossary/エンドポイント/)が削除されることがあります。
