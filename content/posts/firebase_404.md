...
[デプロイ](/glossary/デプロイ/)時の関数名やリージョン指定が変わると、呼び出し[URL](/glossary/url/)が無効になります。
...
Firestoreは明示的にコレクション・ドキュメントを作成する必要があります。存在しない[パス](/glossary/パス/)へのアクセスは404になります。
...
**原因4：Realtime Databaseの[パス](/glossary/パス/)が誤っている**

Realtime Databaseも厳密な[パス](/glossary/パス/)指定が必要です。大文字小文字の違いも404の原因になります。
...
呼び出し[URL](/glossary/url/)は必ず `https://us-central1-<your-project-id>.cloudfunctions.net/getData` になります。異なるリージョンでの[URL](/glossary/url/)アクセスは404になります。

**Realtime DatabaseとHosting [URL](/glossary/url/)の混同**
