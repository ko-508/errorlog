...
> この記事では、**Firebase** を使っているときに表示される **404** というエラーの意味と、その直し方を順を追って説明します。

---

## Firebase の 404 とは何か？（公式の定義）
...
- FirestoreのドキュメントIDまたはパスが間違っている
- Cloud Functionsの[エンドポイント](/glossary/エンドポイント/)のパスが誤っている
...
1. Firebase[コンソール](/glossary/コンソール/)で対象のコレクションとドキュメントの存在を目視確認する
1. Cloud FunctionsのURLを[コンソール](/glossary/コンソール/)のFunctions一覧画面からコピーして使う
...
Firebase の **404** エラーは、上記のいずれかの原因によって発生するケースがほとんどです。
