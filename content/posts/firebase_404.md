...
date: 2026-05-24
description: "この記事では、**Firebase** を使っているときに表示される **404** というエラーの意味と、その直し方を順を追って説明します。"
tags: ["Firebase"]
---
...
- Cloud Functionsのエンドポイントのパスが誤っている
...
1. Firebaseコンソールで対象のコレクションとドキュメントの存在を目視確認する
1. Cloud FunctionsのURLをコンソールのFunctions一覧画面からコピーして使う
