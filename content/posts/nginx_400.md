...
> クライアントからの[リクエスト](/glossary/リクエスト/)の形式が正しくない。
...
- [リクエスト](/glossary/リクエスト/)[ヘッダー](/glossary/ヘッダー/)のサイズがlarge_client_header_buffersの設定を超えている
- URLに不正な文字やエンコードが含まれている
- [HTTPS](/glossary/https/)[エンドポイント](/glossary/エンドポイント/)に[HTTP](/glossary/http/)でアクセスしている
