...
**なぜ発生するか**  
[URL](/glossary/url/) に日本語やマルチバイト文字が直接含まれていたり、%エンコーディングが不正な場合、Nginx が [HTTP](/glossary/http/) 仕様違反と判定します。ブラウザから自動的に送信される場合や[API](/glossary/api/) クライアントの設定ミスで発生することが多いです。
