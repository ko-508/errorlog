...
> この記事では、**GitHub [API](/glossary/api/)** を使っているときに表示される **502** というエラーの意味と、その直し方を順を追って説明します。
...
> GitHubの[インフラ](/glossary/インフラ/)内部で、あるサーバーが別のサーバーから不正な応答を受け取った。
...
GitHub [API](/glossary/api/) で 502 が出るときに、最もよく見られる原因を挙げます。
自分の状況に当てはまるものを探してみてください。

- GitHubの[デプロイ](/glossary/デプロイ/)やメンテナンス中に発生することが多い
...
GitHub [API](/glossary/api/) の **502** エラーは、上記のいずれかの原因によって発生するケースがほとんどです。
